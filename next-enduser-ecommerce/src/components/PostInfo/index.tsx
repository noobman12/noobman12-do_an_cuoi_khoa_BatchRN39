...
export const PostInfo = ({
  ...
  return (
    <>
      <div className='flex'>
        <div className='flex items-center user mt-[14px] md:mt-[16px] lg:mt-[22px]'>
          <Image
            src='/images/icon-user.png' // Đường dẫn tới ảnh
            alt=''
            width={20} // Chiều rộng lớn nhất
            height={20} // Chiều cao lớn nhất
            className='object-cover mt-[4px] md:mt-[8px] lg:mt-[3px] sm:w-[13px] sm:h-[13px] md:w-[20px] md:h-[20px] w-[20px] h-[20px] block'
          />
          <span className='text-[dark] text-[12px] md:text-[16px] lg:text-[16px] font-medium font-raleway ml-[8px] pr-[12px] mt-[8px] md:mt-[10px] lg:mt-[5px]'>
            By {user}
          </span>
        </div>
      ...
      <a href='#'>
        <div className='hover:bg-slate-900 hover:text-white font-raleway font-light text-[16px] mt-[24px] border-2 border-[#24201C] sm:w-[120px] sm:h-[28px] md:w-[150px] md:h-[32px] lg:w-[183px] lg:h-[43px] content-center text-center'>
          READ MORE
        </div>
      </a>
    </>
