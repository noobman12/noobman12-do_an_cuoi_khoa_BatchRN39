  ...
  return (
    <div className="h-[115px] bg-black text-[#fff] flex flex-col md:flex-row justify-between items-center gap-5 md:gap-10 px-5">
      ...
      <div className="flex gap-2 md:gap-4 items-center">
        <div
          className="flex items-center gap-[8px] px-[8px] py-[16px] hover:text-gray-400 transition duration-300 ease-in-out italic text-[14px] md:text-[16px]"
        ...
        <div
          className="flex items-center gap-[4px] px-[8px] py-[16px] relative hover:text-gray-400 transition duration-300 ease-in-out"
            ...
            {["home", "shop", "about", "pages", "contact", "collection"].map(
              (item, index) => (
                <div
                  ...
                  onClick={() => {
                    setIsMenuOpen(false);
                    router.push(`/${item}`); // Navigate to the corresponding route
                  }}
                >
                  {item}
                </div>
