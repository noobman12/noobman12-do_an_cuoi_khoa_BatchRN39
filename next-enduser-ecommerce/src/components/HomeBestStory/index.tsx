      ...
      <div className="flex flex-col gap-[56px]">
        ...
        <div className="group relative">
          <Image
            ...
            alt="bestStory"
            width={980} // Kích thước tối đa theo class Tailwind là 980px
            height={500} // Đặt chiều cao phù hợp để giữ tỉ lệ
            className="w-full md:w-[980px]"
            layout="responsive" // Layout responsive để tự động thay đổi theo kích thước
          />
